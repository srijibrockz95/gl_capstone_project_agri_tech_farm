...
KINESIS_DATA_STREAM = "TestStream07"
...
def publishDummyData(loopCount):
	...
	print(messageJson)
	response = kinesis_handle.put_record(StreamName=KINESIS_DATA_STREAM, Data = messageJson, PartitionKey=sprinkler)
	#print(response)
